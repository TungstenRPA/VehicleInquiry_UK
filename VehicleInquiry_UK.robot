...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <typed-variables>
      ...
      <typed-variable name="vehicleInquiry" type-name="VehicleInquiry"/>
    </typed-variables>
    <parameters/>
    <return-variables/>
    ...
    <triggers/>
    <sub-robots>
      <sub-robot name="VehicleInquiry_UK_Website"/>
    </sub-robots>
    <device-mappings/>
    <referenced-snippets/>
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="0">vehicleInquiry</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">VehicleInquiry</property>
        </property>
      </property>
    </object>
  </property>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="2">
        <property name="name" class="String">False Registration Number</property>
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
            <property name="value" class="String">YC08 OAX</property>
          </property>
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">input.RegistrationNumber</property>
          </property>
        </property>
      ...
      <object class="Transition" serializationversion="3" id="4">
        <property name="name" class="String">Call VehicleInquiry_UK_Website</property>
        <property name="stepAction" class="CallRobot2Step" serializationversion="0">
          <property name="robot2Name" class="String">VehicleInquiry_UK_Website</property>
